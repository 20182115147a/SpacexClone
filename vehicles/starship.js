...
//  }
 ...
 btnTransporter.onclick = function(){
   ...
   content.style.display = 'none';
   footer.style.display = 'none';
   transporterVd.src='https://www.youtube.com/embed/z9eoubnO-pE?autoplay=1'
 }
 btnModalTransporterClose.onclick = function(){
   ...
   content.style.display = 'block';
   footer.style.display = 'block';
   transporterVd.src='https://www.youtube.com/embed/z9eoubnO-pE'
 }
...
// var imgUrls1 = ['../assets/img/falcon_slide2.webp','../assets/img/falcon_slide2a.webp'
// ,'../assets/img/falcon_slide2b.webp']
...
var imgUrls2 = ['../assets/img/starship_slide4.webp','../assets/img/starship_slide4a.webp']
sliderNavItems2.forEach(function(sliderNavItem,index){
    sliderNavItem.onclick = function(){
        sliderNavItems2.forEach(function(sliderNavItem1,index2){
            sliderNavItem1.classList.remove('active')
            slideItems[3].style.backgroundImage = `url(${imgUrls2[index]})`
